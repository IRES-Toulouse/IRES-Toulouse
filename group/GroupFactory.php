...
class GroupFactory {
    ...
    public static function init() {
        ...
        $sql_create_group = "CREATE TABLE $table_name (
                ...
                FOREIGN KEY (creator_id) REFERENCES {$db->prefix}users(ID),
        ...
        $sql_create_user_group = "CREATE TABLE $table_name (
                ...
                FOREIGN KEY (user_id) REFERENCES {$db->prefix}users(ID) ON DELETE CASCADE,
                FOREIGN KEY (group_id) REFERENCES {$db->prefix}groups(id_group) ON DELETE CASCADE,
                PRIMARY KEY (ID)
            ) $charset_collate;";
